...
This project contains the necessary setup configuration to use Scott with JUnit (see [pom.xml](https://github.com/dodie/scott/blob/master/scott-example/pom.xml))
